...
def prediction2map(rxn, prediction, template_extractor, neighbor_weight=10):
    ...
    try:
        origin_template, canonical_template, atoms_to_use_reactant, atoms_to_use_product = template_extractor(mapped_rxn)
        template = {
