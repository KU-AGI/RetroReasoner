...
def get_fragments_for_changed_atoms(mols, changed_atom_tags, category = 'reactant', special_atoms = []):
    ...
    for mol in mols:
        ...
        atoms_to_use_all.append(atoms_to_use)
    ...
    return fragments[:-1], intra_only, dimer_only, mols_special, special_atoms, atoms_to_use_all
...
def extract_from_reaction(reaction, update_setting = {}):
    ...
    try:
        reactant_fragments, _, _, reactants, special_atoms, atoms_to_use_reactant = get_fragments_for_changed_atoms(reactants, changed_atom_tags, 'reactant', [])
        product_fragments, _, _, _, _, atoms_to_use_product  = get_fragments_for_changed_atoms(products, changed_atom_tags, 'product', special_atoms)
    ...
    return rxn_string, canonical_template, atoms_to_use_reactant, atoms_to_use_product